...
| 📅 **Kalender** | Termine direkt eintragen, einmalig oder wiederkehrend. Oder Kalender aus Apple, Google und Outlook per iCal-Adresse abonnieren — das Dashboard holt selbst, stündlich. `.ics`-Dateien in data/ics/ werden weiter gelesen. |
...
| 🌧️ **Wetter mit Regenzeiten** | Nicht „98 % Regen", sondern **„Regen ab 18:30"**. Die Regenwahrscheinlichkeit der nächsten Stunden als Balken unter der Temperaturkurve, für jeden Tag Menge und Zeitfenster. Wo Open-Meteo Viertelstundenwerte liefert (Mitteleuropa, DWD-Modell), wird es entsprechend genau. |
| 🖼️ **Foto-Rahmen & Diashow** | Bilder hochladen, wechseln automatisch. Ein Knopf schaltet auf **Vollbild**: nur Foto, Uhrzeit, Wetter und was heute noch ansteht — ganz ohne Adressleiste, auch im Browser. |
